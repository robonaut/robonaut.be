...
deploy:
	# js and css
	aws s3 sync ./dist s3://www.robonaut.be --region eu-central-1 --metadata-directive REPLACE --acl public-read  --exclude "*" --include "*.js" --include "*.css" --cache-control max-age=2592000,public
	# html files
